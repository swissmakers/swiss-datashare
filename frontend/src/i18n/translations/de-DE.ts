export default {
  ...
  "account.reverseShares.modal.send-email.description": "Sendet eine E-Mail Benachrichtigung, sobald neueDateien auf deiner Dateianfrage hochgeladen werden.",
  ...
  "account.reverseShares.modal.public-access.description": "Mache die Dateianfragen die mit dieser Dateianfrage erstellt werden öffentlich. Wenn dies deaktiviert ist, haben nur du und der Ersteller der Dateianfrage Zugriff darauf.",
  ...
  "account.reverseShare.never-expires": "Diese Dateianfrage wird nicht ablaufen.",
  "account.reverseShare.expires-on": "Diese Dateianfrage wird am {expiration} ablaufen.",
