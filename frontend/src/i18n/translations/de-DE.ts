export default {
  ...
  "signup.disabled.title": "Selbstregistrierung ist deaktiviert",
  "signup.disabled.description.with-email": "Aus Sicherheitsgründen ist die Selbstregistrierung in diesem System deaktiviert. Wenn Sie ein Konto benötigen, wenden Sie sich bitte an {appName} unter {contactEmail}.",
  "signup.disabled.description.no-email": "Aus Sicherheitsgründen ist die Selbstregistrierung in diesem System deaktiviert. Wenn Sie ein Konto benötigen, wenden Sie sich bitte an die Administratoren von {appName}.",
  ...
  "admin.config.general.contact-email": "Kontakt-E-Mail für Kontoanfragen",
  "admin.config.general.contact-email.description": "E-Mail-Adresse, die angezeigt wird, wenn die Selbstregistrierung deaktiviert ist. Benutzer können diese Adresse verwenden, um ein Konto anzufragen.",
