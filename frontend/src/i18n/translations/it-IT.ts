export default {
  ...
  "navbar.avatar.contacts": "I miei contatti",
  ...
  "signup.disabled.title": "La registrazione autonoma è disabilitata",
  "signup.disabled.description.with-email": "Per motivi di sicurezza, la registrazione autonoma è disabilitata su questo sistema. Se hai bisogno di un account, contatta {appName} all'indirizzo {contactEmail}.",
  "signup.disabled.description.no-email": "Per motivi di sicurezza, la registrazione autonoma è disabilitata su questo sistema. Se hai bisogno di un account, contatta gli amministratori di {appName}.",
  ...
  "account.card.billing.title": "Fatturazione",
  "account.card.billing.status": "Stato abbonamento: {status}",
  "account.card.billing.status-value.none": "Nessun abbonamento",
  "account.card.billing.status-value.active": "Attivo",
  "account.card.billing.status-value.trialing": "Periodo di prova",
  "account.card.billing.status-value.past_due": "Pagamento in ritardo",
  "account.card.billing.status-value.unpaid": "Non pagato",
  "account.card.billing.status-value.canceled": "Annullato",
  "account.card.billing.status-value.incomplete": "Incompleto",
  "account.card.billing.status-value.incomplete_expired": "Incompleto (scaduto)",
  "account.card.billing.status-value.paused": "In pausa",
  "account.card.billing.trial-ends": "La prova termina il {date}",
  "account.card.billing.next-payment": "Prossimo pagamento il {date}",
  "account.card.billing.cancel-scheduled": "Il tuo abbonamento è annullato e resta attivo fino al {date}.",
  "account.card.billing.grace-ends": "Il periodo di grazia termina il {date}",
  "account.card.billing.subscribe-monthly": "Abbonati mensilmente",
  "account.card.billing.subscribe-yearly": "Abbonati annualmente",
  "account.card.billing.subscribe-locked": "Le opzioni di abbonamento sono disabilitate finché l’abbonamento attuale è attivo.",
  "account.card.billing.manage": "Gestisci fatturazione",
  ...
  "account.reverseShares.modal.name.label": "Nome",
  "account.reverseShares.modal.name.placeholder": "Nome facoltativo per questa richiesta di file",
  ...
  "account.reverseShares.table.name": "Nome",
  ...
  "contacts.page-title": "I miei contatti",
  "contacts.title": "I miei contatti",
  "contacts.add": "Aggiungi contatto",
  "contacts.add-first": "Aggiungi il primo contatto",
  "contacts.empty.title": "Nessun contatto salvato",
  "contacts.empty": "Nessun contatto salvato. Aggiungi contatti per selezionare rapidamente i destinatari quando condividi via e-mail.",
  "contacts.search.label": "Cerca",
  "contacts.search.placeholder": "Nome, e-mail o tipo…",
  "contacts.table.kind": "Tipo",
  "contacts.table.name": "Nome",
  "contacts.table.email": "E-mail",
  "contacts.table.notes": "Note",
  "contacts.edit": "Modifica contatto",
  "contacts.delete": "Elimina contatto",
  "contacts.kind.person": "Persona",
  "contacts.kind.company": "Azienda",
  "contacts.kind.institution": "Istituzione",
  "contacts.form.kind": "Tipo",
  "contacts.form.name": "Nome",
  "contacts.form.email": "Indirizzo e-mail",
  "contacts.form.notes": "Note (facoltativo)",
  "contacts.modal.add-title": "Aggiungi contatto",
  "contacts.modal.edit-title": "Modifica contatto",
  "contacts.saved": "Contatto aggiornato",
  "contacts.created": "Contatto aggiunto",
  "contacts.deleted": "Contatto rimosso",
  "contacts.load-error": "Impossibile caricare i contatti",
  "contacts.delete-error": "Impossibile eliminare il contatto",
  "contacts.delete.title": "Elimina contatto",
  "contacts.delete.body": "Rimuovere {name} ({email}) dai contatti?",
  "contacts.delete.confirm": "Elimina",
  "contacts.error.name-required": "Inserisci un nome.",
  "contacts.error.invalid-email": "Inserisci un indirizzo e-mail valido.",
  "contacts.error.save-failed": "Impossibile salvare il contatto.",
  "contacts.back-to-account": "Torna al mio account",
  ...
  "admin.users.table.subscription": "Abbonamento",
  "admin.users.table.subscription.valid": "Valido",
  "admin.users.table.subscription.invalid": "Non valido",
  "admin.users.table.subscription.exempt": "Esente",
  ...
  "admin.version.current": "Versione attuale: {version}",
  "admin.version.update-available": "Nuova versione disponibile: {version}",
  "admin.version.view-release": "Vedi rilascio",
  "admin.version.up-to-date": "Sei aggiornato.",
  ...
  "upload.modal.accordion.email.placeholder": "Inserisci le email dei destinatari (confermare con Enter)",
  "upload.modal.accordion.email.invalid-email": "Indirizzo email non valido",
  "upload.modal.accordion.email.helper": "Lascia vuoto se invii tu stesso il link ai dati, oppure aggiungi qui i destinatari per inviare il link direttamente via email.",
  ...
  "upload.reverse-share.note.placeholder": "Aggiungi contesto sui file inviati",
  "upload.reverse-share.note.helper": "Il tuo messaggio verrà mostrato al richiedente nella notifica.",
  "upload.reverse-share.button.finish": "Termina caricamento",
  ...
  "admin.config.general.contact-email": "Email di contatto per richieste di account",
  "admin.config.general.contact-email.description": "Indirizzo email mostrato quando la registrazione autonoma è disabilitata. Gli utenti possono usare questo indirizzo per richiedere un account.",
  ...
  "admin.config.general.custom-head-css": "CSS aggiuntivo",
  "admin.config.general.custom-head-css.description":
    "CSS opzionale per la pagina. Usare !important per sovrascrivere certi stili empaquetati.",
  "admin.config.general.custom-head-js": "JavaScript aggiuntivo",
  "admin.config.general.custom-head-js.description":
    "JavaScript opzionale per la pagina.",
  ...
  "admin.config.saas.enabled": "Abilita fatturazione SaaS",
  "admin.config.saas.enabled.description": "Abilita fatturazione SaaS e controlli abbonamento quando il caso d’uso include «saas».",
  "admin.config.saas.monthly-price-chf": "Prezzo mensile (CHF)",
  "admin.config.saas.monthly-price-chf.description": "Prezzo dell’abbonamento mensile mostrato in franchi svizzeri.",
  "admin.config.saas.yearly-price-chf": "Prezzo annuale (CHF)",
  "admin.config.saas.yearly-price-chf.description": "Prezzo dell’abbonamento annuale mostrato in franchi svizzeri.",
  "admin.config.saas.trial-days": "Giorni di prova",
  "admin.config.saas.trial-days.description": "Numero di giorni gratuiti dopo la registrazione prima che sia richiesto un abbonamento.",
  "admin.config.saas.grace-days": "Giorni di grazia",
  "admin.config.saas.grace-days.description": "Giorni aggiuntivi dopo la scadenza dell’abbonamento prima di bloccare caricamento e condivisione.",
  "admin.config.saas.enforce-subscription": "Applica abbonamento",
  "admin.config.saas.enforce-subscription.description": "Se abilitato, gli utenti in ritardo, non esenti e non amministratori sono bloccati per caricamento e condivisione.",
  "admin.config.saas.stripe-publishable-key": "Chiave pubblicabile Stripe",
  "admin.config.saas.stripe-publishable-key.description": "Chiave pubblica Stripe usata dal frontend per la fatturazione.",
  "admin.config.saas.stripe-secret-key": "Chiave segreta Stripe",
  "admin.config.saas.stripe-secret-key.description": "Chiave segreta Stripe usata dal backend per sessioni di pagamento e abbonamenti.",
  "admin.config.saas.stripe-webhook-secret": "Segreto webhook Stripe",
  "admin.config.saas.stripe-webhook-secret.description": "Segreto di firma per verificare gli eventi webhook Stripe.",
  "admin.config.saas.stripe-monthly-price-id": "ID prezzo mensile Stripe",
  "admin.config.saas.stripe-monthly-price-id.description": "ID prezzo dell’abbonamento mensile in Stripe.",
  "admin.config.saas.stripe-yearly-price-id": "ID prezzo annuale Stripe",
  "admin.config.saas.stripe-yearly-price-id.description": "ID prezzo dell’abbonamento annuale in Stripe.",
  "admin.config.saas.exempt-users.title": "Utenti esenti",
  "admin.config.saas.exempt-users.search": "Cerca utenti per nome o email",
  "admin.config.saas.exempt-users.exempt": "Esenta",
  "admin.config.saas.exempt-users.add": "Esenta utente",
  "admin.config.saas.exempt-users.remove": "Rimuovi esenzione",
  "admin.config.saas.payments.title": "Cronologia pagamenti",
  "admin.config.saas.payments.month": "Totale questo mese",
  "admin.config.saas.payments.year": "Totale quest’anno",
  "admin.config.saas.payments.all-time": "Totale da sempre",
  "admin.config.saas.payments.amount": "Importo",
  "admin.config.saas.payments.status": "Stato",
