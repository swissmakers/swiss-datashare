export default {
  ...
  "navbar.avatar.contacts": "My contacts",
  ...
  "signup.disabled.title": "Self-registration is disabled",
  "signup.disabled.description.with-email": "For security reasons, self-registration is disabled on this system. If you need an account, please contact {appName} at {contactEmail}.",
  "signup.disabled.description.no-email": "For security reasons, self-registration is disabled on this system. If you need an account, please contact the administrators of {appName}.",
  ...
  "contacts.page-title": "My contacts",
  "contacts.title": "My contacts",
  "contacts.add": "Add contact",
  "contacts.add-first": "Add your first contact",
  "contacts.empty.title": "No saved contacts yet",
  "contacts.empty": "You have no saved contacts yet. Add contacts to quickly pick recipients when sharing by email.",
  "contacts.search.label": "Search",
  "contacts.search.placeholder": "Name, email, or type…",
  ...
  "contacts.kind.company": "Company",
  "contacts.kind.institution": "Institution",
  "contacts.form.kind": "Type",
  "contacts.form.name": "Name",
  "contacts.form.email": "Email address",
  "contacts.form.notes": "Notes (optional)",
  "contacts.modal.add-title": "Add contact",
  "contacts.modal.edit-title": "Edit contact",
  "contacts.saved": "Contact updated",
  "contacts.created": "Contact added",
  "contacts.deleted": "Contact removed",
  "contacts.load-error": "Could not load contacts",
  "contacts.delete-error": "Could not delete contact",
  "contacts.delete.title": "Delete contact",
  "contacts.delete.body": "Remove {name} ({email}) from your contacts?",
  "contacts.delete.confirm": "Delete",
  "contacts.error.name-required": "Please enter a name.",
  "contacts.error.invalid-email": "Please enter a valid email address.",
  "contacts.error.save-failed": "Could not save contact.",
  "contacts.back-to-account": "Back to my account",
  ...
  "admin.version.current": "Current version: {version}",
  "admin.version.update-available": "New version available: {version}",
  "admin.version.view-release": "View release",
  "admin.version.up-to-date": "You are up to date.",
  ...
  "admin.config.general.contact-email": "Contact email for account requests",
  "admin.config.general.contact-email.description": "Email address shown when self-registration is disabled. Users can contact this address to request an account.",
  ...
  "admin.config.ldap.ignore-tls-verification": "Ignore TLS certificate verification",
  "admin.config.ldap.ignore-tls-verification.description":
    "For ldaps:// only: accept self-signed or otherwise untrusted server certificates. Insecure—use only in development or with a private CA you trust; prefer installing the CA in the container instead.",
  ...
  "common.error.request-timeout": "The server did not respond in time. Please try again or reload the page.",
