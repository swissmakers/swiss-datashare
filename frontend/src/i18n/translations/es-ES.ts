export default {
  ...
  "navbar.avatar.contacts": "Mis contactos",
  "navbar.avatar.admin": "Administración",
  "navbar.avatar.signout": "Cerrar sesión",
  "navbar.avatar.signed-in-as": "Conectado como",
  ...
  "signup.disabled.title": "El auto-registro está desactivado",
  "signup.disabled.description.with-email": "Por razones de seguridad, el auto-registro está desactivado en este sistema. Si necesitas una cuenta, por favor contacta a {appName} en {contactEmail}.",
  "signup.disabled.description.no-email": "Por razones de seguridad, el auto-registro está desactivado en este sistema. Si necesitas una cuenta, por favor contacta a los administradores de {appName}.",
  ...
  "contacts.page-title": "Mis contactos",
  "contacts.title": "Mis contactos",
  "contacts.add": "Añadir contacto",
  "contacts.add-first": "Añadir el primer contacto",
  "contacts.empty.title": "Aún no hay contactos",
  "contacts.empty": "Aún no hay contactos guardados. Añada contactos para elegir rápidamente destinatarios al compartir por correo.",
  "contacts.search.label": "Buscar",
  "contacts.search.placeholder": "Nombre, correo o tipo…",
  "contacts.table.kind": "Tipo",
  "contacts.table.name": "Nombre",
  "contacts.table.email": "Correo",
  "contacts.table.notes": "Notas",
  "contacts.edit": "Editar contacto",
  "contacts.delete": "Eliminar contacto",
  "contacts.kind.person": "Persona",
  "contacts.kind.company": "Empresa",
  "contacts.kind.institution": "Institución",
  "contacts.form.kind": "Tipo",
  "contacts.form.name": "Nombre",
  "contacts.form.email": "Correo electrónico",
  "contacts.form.notes": "Notas (opcional)",
  "contacts.modal.add-title": "Añadir contacto",
  "contacts.modal.edit-title": "Editar contacto",
  "contacts.saved": "Contacto actualizado",
  "contacts.created": "Contacto añadido",
  "contacts.deleted": "Contacto eliminado",
  "contacts.load-error": "No se pudieron cargar los contactos",
  "contacts.delete-error": "No se pudo eliminar el contacto",
  "contacts.delete.title": "Eliminar contacto",
  "contacts.delete.body": "¿Eliminar {name} ({email}) de sus contactos?",
  "contacts.delete.confirm": "Eliminar",
  "contacts.error.name-required": "Introduzca un nombre.",
  "contacts.error.invalid-email": "Introduzca un correo válido.",
  "contacts.error.save-failed": "No se pudo guardar el contacto.",
  "contacts.back-to-account": "Volver a mi cuenta",
  ...
  "admin.version.current": "Versión actual: {version}",
  "admin.version.update-available": "Nueva versión disponible: {version}",
  "admin.version.view-release": "Ver versión",
  "admin.version.up-to-date": "Está actualizado.",
  ...
  "admin.config.general.contact-email": "Correo de contacto para solicitudes de cuenta",
  "admin.config.general.contact-email.description": "Dirección de correo mostrada cuando el auto-registro está desactivado. Los usuarios pueden contactar esta dirección para solicitar una cuenta.",
  ...
  "admin.config.general.default-locale": "Idioma predeterminado",
  "admin.config.general.default-locale.description": "Idioma de interfaz predeterminado para visitantes anónimos y para usuarios nuevos hasta que elijan otro en su cuenta. Las páginas de subida por compartición inversa usan el idioma del creador (salvo que el visitante ya haya elegido un idioma mediante la cookie).",
  "admin.config.general.logo": "Logo",
  "admin.config.general.logo.description": "Sube un logo PNG. Se admiten imágenes cuadradas, anchas o altas; usa el tamaño y la opción de cabecera abajo para ajustarlo a la barra, la página de inicio y los correos.",
  ...
  "admin.config.ldap.ignore-tls-verification": "Ignorar la verificación del certificado TLS",
  "admin.config.ldap.ignore-tls-verification.description":
    "Solo para ldaps://: aceptar certificados del servidor autofirmados o no confiables. Inseguro—solo en desarrollo o con una CA privada de confianza; es preferible instalar la CA en el contenedor.",
