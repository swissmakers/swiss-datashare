...
const emailMessages: Record<SupportedEmailLocale, EmailCopy> = {
  ...
  "fr-FR": {
    ...
    reverseShare: {
      ...
      intro: "Le partage a été effectué par {creator} ({creatorEmail}).",
  ...
  "es-ES": {
    ...
    reverseShare: {
      ...
      intro: "El contenido fue compartido por {creator} ({creatorEmail}).",
  ...
  "it-IT": {
    ...
    reverseShare: {
      ...
      intro: "La condivisione è stata effettuata da {creator} ({creatorEmail}).",
